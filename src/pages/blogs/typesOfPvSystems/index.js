...
const PvSystems = () => {
   return (
      <Wrapper>
         <Head>
            <meta name='title' content={'Blog - Types of Pv Systems'} />
            <meta property='og:title' content={'Blog - Types of Pv Systems'} />
            <meta
               name='description'
               content={
                  'Solar Photovoltaic Systems has three types which are grid connected, Stand-alone, and hybrid systems. But how you can identify which one of the solar systems is best for you? We will help you to identify the best option'
               }
            />

            <title>Blog - Types of Pv System</title>
         </Head>

         <BlogsTopIntroSection title='Types of PV Systems' />
         <Container maxWidth='lg' sx={{ padding: { sm: '20px', xs: 0 } }}>
            ...
            <Flex sx={{ flexDirection: { sm: 'row', xs: 'column' } }}>
               <BlogTitledBox
                  ...
                  sx={{ mr: { sm: 3, xs: 0 } }}
               >
                  In a hybrid system once the solar power is used by the
                  appliances in your property, any excess power will be sent to
                  the battery bank. Once the battery bank is fully charged, it
                  will stop receiving power from the solar system. The energy
                  from the battery can then be discharged and used to power your
                  home, usually during the peak evening period when the cost of
                  electricity is typically at its highest.
               </BlogTitledBox>
               <BlogTitledBox title='ELECTRICITY GRID'>
                  Depending on how your hybrid system is set up and whether your
                  utility allows it, once your batteries are fully charged
                  excess solar power not required by your appliances can be
                  exported to the grid via your meter. When your solar system is
                  not in use, and if you have drained the usable power in your
                  batteries your appliances will then start drawing power from
                  the grid.
               </BlogTitledBox>
            </Flex>
         </Container>
