...
const WestBengal = () => {
   ...
   return (
      <>
         <Head>
            <title>Net Metering - West Bengal</title>
         </Head>
         <Wrapper>
            ...
            <Container maxWidth='lg' sx={{ padding: { sm: '20px', xs: 0 } }}>
               <Para sx={{ padding: { xs: '20px', sm: 0 } }}>
                  ...
                  solar energy panels in the country. As the degree of
                  urbanization in West Bengal is rapidly growing at the rate of
                  3.92% (Sultana, 2015) energy demand is estimated to be at a
                  high. The state government has ambitious plans and more than
                  1300 government buildings, hospitals and schools have been
                  identified to help install about 180MW of solar in the next
                  couple of years. The state has an installed solar capacity of
                  94 MW as of September 2019, while 64 MW of solar projects are
                  currently under development. It is mandatory for all large
                  housing societies in West Bengal, (having a total contract
                  demand of more than 500 kW) to install solar rooftop systems
                  to meet a minimum of 1.5% of their total electrical load by
                  solar energy. The subsidies are applicable as per SECI
                  guidelines.
               </Para>
               ...
               >
                  ...
                  <ListingWithHand>
                     <span>👉</span>
                     Schools / Academic institutions run by Govt./ Private/
                     Govt. aided
                  </ListingWithHand>
                  <ListingWithHand>
                     <span>👉</span>
                  ...
                  <ListingWithHand>
                     <span>👉</span>
                     The parties should also be a consumer of WBSEDCL and apply
                     for installation capacity not less than 5KW with a
                     connection type of 3 phase.
                  </ListingWithHand>
               </BlogTitledBox>
               ...
               >
                  <Para sx={{ mb: 3 }}>
                     ...
                     into the distribution network of the licensee gets adjusted
                     to the maximum extent of 90% against the drawal of energy
                     by the consumer from the grid. The balance of unadjusted
                     injection of energy by the solar PV system, if any, is
                     carried forward to the next billing period. This process of
                     adjustment will be continued for the entire financial year.
                     At the end of the financial year, after effecting the final
                     adjustment for that month, surplus injection from solar PV
                     system will be treated as unwanted / inadvertent injection.
                  </Para>
               </BlogTitledBox>
                  ...
                  <Grid item xs={12} md={6}>
                     <ApprovalBox>
                        ...
                        <Ol type='1'>
                           ...
                           <li>
                              <Typography>
                                 In the “Rooftop Solar Sources - Net Metering”
                                 from the “CONSUMER CORNER” on the homepage,
                                 click on the login portal.
                              </Typography>
                           </li>
                           <li>
                              <Typography>
                                 In the login portal fill up and submit the
                                 ‘Form S1’ for application submission. The
                                 application receipt received will be ‘Form S2’
                              </Typography>
                           </li>
                           <li>
                              <Typography>
                                 After the application has been approved and
                                 passed further for inspection, please file the
                                 “Tech feasibility and eligibility report” in
                                 the “Form S3”.
                              </Typography>
                           </li>
                           <li>
                  ...
                  <Grid item xs={12} md={6}>
                     <DocumentBox sx={{ padding: { sm: 0, xs: '20px' } }}>
                        ...
                        <UtilityList>
                           <DoneIcon />
                           <Typography>
                              Acceptance by the consumer bearing the cost for
                              phase conversion/alteration of service
                           </Typography>
                        </UtilityList>
                        <UtilityList>
                           <DoneIcon />
               ...
               >
                  <Para sx={{ mb: 3 }}>
                     ...
                     90% of the benchmark cost is provided as discount to
                     farmers for installations of Solar water pumping system.
                  </Para>
               </BlogTitledBox>
                              ...
                              <ul>
                                 <li>
                                    <Typography>
                                       ...
                                       solar rooftop systems to meet at least
                        ...
                        <Box sx={{ mt: 4 }}>
                           ...
                           <GrayBox>
                              <ul>
                                 ...
                                 <li>
                                    <Typography>
                                       Any unadjusted electricity credits shall
                                       be paid as per the rates notified by
                                       MERC.
                                    </Typography>
                                 </li>
                              </ul>
                        ...
                        <Box sx={{ mt: 4 }}>
                           ...
                           <GrayBox>
                              <ul>
                                 ...
                                 <li>
                                    <Typography>
                                       Loans available for up to Rs.15 Crore for
                                       renewable energy projects under Priority
                                       sector lending
                                    </Typography>
                                 </li>
                                 <li>
                                    <Typography>
                                       ...
                                       of Credit from a nationalized bank as a
                                       payment security mechanism for all RE
                                       projects.
                                    </Typography>
                                 </li>
                              </ul>
