...
const Maharashtra = () => {
   ...
   const { t: translate } = useTranslation('maharashtra');
   ...
   const handleChange = (e, newValue) => {
      ...
      setValue(newValue);
      if (newValue === 0) {
         push('/blogs/netMetering/maharashtra', undefined, { locale: 'en' });
      } else {
         push('/blogs/netMetering/maharashtra', undefined, { locale: 'bn' });
      }
   };
      ...
      <>
         <Wrapper>
            <BlogsTopIntroSection
               ...
               title={translate('NET METERING POLICY:')}
               subtitle={translate('MAHARASHTRA')}
               icon={
            ...
            <Container maxWidth='lg' sx={{ padding: { sm: '20px', xs: 0 } }}>
               ...
               <BlogTitledBox
                  title={translate('Parties eligible for net metering policy')}
                  sx={{ mr: { sm: 3, xs: 0 } }}
                  variant='tertiary'
               >
                  <ListingWithHand>
                     <span>👉</span>
                     {translate('Consumer of the local distribution licensee')}
                  </ListingWithHand>

                  <ListingWithHand>
                     <span>👉</span>
                     {translate(
                        `Owner or in legal possession of the premises including the rooftop or terrace or building or infrastructure or open areas of the land or part or combination thereof on which the Solar PV System is proposed to be installed.`
                     )}
                  </ListingWithHand>
                  <ListingWithHand>
                     <span>👉</span>
               ...
               <BlogTitledBox
                  title={translate('Net-metering policy arrangement')}
                  sx={{ mr: { sm: 3, xs: 0 } }}
                  variant='tertiary'
               >
                  <Para sx={{ mb: 3 }}>
                  ...
                  <ListingWithHand>
                     ...
                     {translate(
                        `The application for grid connectivity by the project developer will be scrutinised by the Committee for grid connectivity constituted by MSETCL in which thorough consultation will be done.`
                     )}
                  </ListingWithHand>
               </BlogTitledBox>
               ...
               >
                  {translate('List of Documents Required')}
               </Typography>
               ...
               <Grid container spacing={3} alignItems='stretch'>
                  <Grid item xs={12} md={6}>
                     <ApprovalBox>
                        ...
                        >
                           {translate('Application for Net-Metering approval')}
                        </Typography>
                        ...
                        <Ol type='1'>
                           <li>
                              <Typography>
                                 {translate(
                                    `Visit the Maharashtra State Electricity Distribution Company Limited (Mahadiscom) website: After entering into the Consumer Access Portal, Under the “Quick Access” tab, and apply for RE Rooftop link.`
                                 )}
                              </Typography>
                           </li>
                           ...
                           <li>
                              <Typography>
                                 {translate(
                                    `Fill up the application form. Cost of Net Meter, Generation meter (Source wise) and all costs related to the setting up PV system shall be borne by consumer.`
                                 )}
                              </Typography>
                           </li>
                           <li>
                              <Typography>
                                 {translate(
                                    `When we apply Net-Meter for grid connected solar system it will take approx. 30 days to 90 days depending on power distribution companies. Application will be automatically canceled if the PV system is not commissioned within 6 months from the date of Sanction of application.`
                                 )}
                              </Typography>
                              <br />
                              <Typography>
                                 {translate(`Application processing fees for a low Tension
                                    consumer is Rs. 500 for consumer having
                                    Sanctioned Load upto 20 kW and Rs 100
                                    thereafter for every 20 kW or part thereof. The
                                    same for a high tension consumer is Rs. 5000/-`)}
                              </Typography>
                           </li>
                        </Ol>
                     </ApprovalBox>
                  ...
                  <Grid item xs={12} md={6}>
                     <DocumentBox sx={{ padding: { sm: 0, xs: '20px' } }}>
                        <UtilityList>
                           <DoneIcon />
                           <Typography>{translate('Aadhar Card')}</Typography>
                        </UtilityList>
                        <UtilityList>
                           <DoneIcon />
                           <Typography>
                              {translate('Latest Electricity Bill')}
                           </Typography>
                        </UtilityList>
                        <UtilityList>
                           <DoneIcon />
                           <Typography>{translate('Photo')}</Typography>
                        </UtilityList>
                        <UtilityList>
                           <DoneIcon />
                           <Typography>{translate('Pan Card')}</Typography>
                        </UtilityList>
                        <UtilityListWithDetails>
                           <Flex>
                              <DoneIcon />
                              <Typography>
                                 {translate('Net Meter Application Form')}
                              </Typography>
                           </Flex>
                           <Box>
                              <Ol type='A'>
                                 <li>
                                    ...
                                    <Ol type='1'>
                                       <li>
                                          <Typography>
                                             {translate(
                                                'Technical details of Renewable Energy Generating Station, Inverter and other equipment of the System proposed to be installed. (Mandatory)'
                                             )}
                                          </Typography>
                                       </li>
                                       <li>
                                 ...
                                 <li>
                                    <Typography sx={{ fontSize: '1rem' }}>
                                       {translate(
                                          'If RE Generating system is not self owned: In addition to above in (a), Third Party Leasing Agreement. (Mandatory)'
                                       )}
                                    </Typography>
                                 </li>
                                 <li>
               ...
               >
                  ...
                  <ListingWithHand>
                     <span>👉</span>
                     {translate(
                        'Required documentation is needed to submit to MEDA online by a developer on behalf of the eligible customer.'
                     )}
                  </ListingWithHand>
                  <ListingWithHand>
                     <span>👉</span>
                     {translate(
                        'Following the provisional approval, the completion report needs to be submitted.'
                     )}
                  </ListingWithHand>
                  <ListingWithHand>
                     <span>👉</span>
                  ...
                  <ListingWithHand>
                     <span>👉</span>
                     {translate(
                        'After all these formalities, the subsidy amount is directly deposited to the customer’s account within 2-3 months of issuing the grant letter.'
                     )}
                  </ListingWithHand>
               </BlogTitledBox>
                  ...
                  <Box sx={{ mt: 0 }}>
                     ...
                     <GrayBox>
                        <ul>
                           ...
                           <li>
                              <Typography>
                                 400/ 415V (Three phase): Above 8 to 150 kWp
                                 max. in Metropolitian Area and 8 to
                              </Typography>
                           </li>
                           <li>
                           ...
                           <li>
                              <Typography>
                                 11 kV and Above Level : Above 150 to 1000kWp
                                 max. in Metropolitian Area and 80 to 1000 kWp
                                 in Other Areas
                              </Typography>
                           </li>
                        </ul>
                        ...
                        <ul>
                           ...
                           <li>
                              <Typography>
                                 ...
                                 paid as per the rates notified by MERC
                              </Typography>
                           </li>
                        </ul>
                     </GrayBox>
                        ...
                        <ul>
                           <li>
                              <Typography>
                                 ...
                                 System. The approval shall be valid for a
                                 period of 6 months from the date of approval,
                                 or such extended period as may be agreed to by
                                 the MSEDCL.
                              </Typography>
                           </li>
                           <li>
                              <Typography>
                                 ...
                                 commissioning of the System within 10 working
                                 days from receipt of testing and commissioning
                                 request, and shall install the Net Metering
                                 equipment and synchronise the Roof-top Solar PV
                                 System within 10 working days thereafter.
                              </Typography>
                           </li>
                        </ul>
                     </GrayBox>
...
export async function getStaticProps({ locale }) {
   return {
      props: {
         ...(await serverSideTranslations(locale, ['maharashtra', 'common'])),
